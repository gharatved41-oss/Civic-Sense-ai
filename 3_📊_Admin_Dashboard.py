...
Admin-only dashboard: stats overview + incident management (update status / delete).
"""
...
style.hero("📊 Admin Dashboard",
           "Overview and management of all reported civic incidents.",
